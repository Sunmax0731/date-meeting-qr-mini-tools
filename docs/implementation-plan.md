...
1. 要件定義、仕様、設計を NON PICKUP Rank 16 と ZIP metadata から再構成。
...
6. `dist/date-meeting-qr-mini-tools-docs.zip` を生成。

## 次フェーズ

- 実ユーザーの手動テスト結果を反映する。
- Chrome Manifest V3 拡張、popup、options、local storage を備えた検証可能な拡張パッケージ を実データで拡張する。
- 配布先 Chrome Web Store 向けの説明画像、サンプルデータ、FAQ を追加する。
